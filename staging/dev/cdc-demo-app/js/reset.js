...
/*var cdcApiData = {
  apiKey: '3_jSofyKuk_nNDESnDYpgqtrQgStu-cnPNiQZwK5Jx1ni3t7ztcdV5zBVQ0Q7ps8Pt',
  brand: 'ELX',
  country: 'GB',
  language: 'EN',
  returnUrl: 'https://identity.myaccount.electroluxgroup.eu/staging/dev/cdc-demo-app/index.html'
}*/
...
var onGigyaServiceReady = function() {
  try {
    const screenSetParams = createScreenSetParameters();
 ...
 */
function createScreenSetParameters() {
  try {
    const screenSetParams = {
      screenSet: `AEG-RegistrationLogin`,
