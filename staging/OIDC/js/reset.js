...
//loadCdcApiDynamically(cdcApiData, isStorageDomainOverride);
  ...
  try {
    ...
    if (cdcApiData.childApiKey) {
      cdcscripturl = `https://cdc.myaccount.electroluxgroup.eu/js/gigya.js?apiKey=4_TySGM90Uf7f7GGLgX4HX-w&childApiKey=${cdcApiData.childApiKey}&lang=${language}`;
    } else {
      cdcscripturl =  `https://cdc.myaccount.electroluxgroup.eu/js/gigya.js?apiKey=4_TySGM90Uf7f7GGLgX4HX-w&lang=${language}`
    }
  } catch (err) {
